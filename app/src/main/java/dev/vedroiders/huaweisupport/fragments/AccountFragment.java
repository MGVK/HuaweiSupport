...
public class AccountFragment extends Fragment implements View.OnClickListener {
    ...
    public AccountFragment(Main2Activity main2Activity) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        LinearLayout linearLayout = (LinearLayout) inflater
                .inflate(R.layout.fragment_account, null);

        linearLayout.findViewById(R.id.ch_name).setOnClickListener(this);
        linearLayout.findViewById(R.id.ch_pass).setOnClickListener(this);
        linearLayout.findViewById(R.id.ch_phone).setOnClickListener(this);
